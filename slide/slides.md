...
| 時間 | セクション | 形式 |
|------|-----------|------|
| 0:00〜0:10 | オリエンテーション | 講義 |
| 0:10〜0:30 | リファクタリング基礎 | 講義 |
| 0:30〜1:00 | 個人演習 | ハンズオン |
| 1:00〜1:05 | 休憩 | — |
| 1:05〜1:25 | ペアレビュー | グループワーク |
| 1:25〜1:40 | 全体共有・解説 | 発表＋講義 |
| 1:40〜1:55 | 変更影響ケーススタディ | 演習 |
| 1:55〜2:00 | まとめ | 講義 |
...
1. コードを読み、**問題点をリストアップ**する（10分）
2. 問題点を優先順位付けし、**改善方針を決める**（5分）
3. Googleドキュメント上で、**改善後のコード**に書き換える（15分）
